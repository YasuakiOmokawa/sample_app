...
// function successAndBefore() {
//   $("#content-active-error-message").addClass('hide');
//   $("#errors ul").empty();
//   // $(ifrm).find(".form-group").removeClass("has-error");
// }

// function detectUploadResult() {
//   $("#new_content").on("ajax:error", function(event, xhr) {
...
//     }));
//   });
//   $("#new_content").on("ajax:success", successAndBefore() );
//   $("#new_content").on("ajax:before", successAndBefore() );
// }
...
//         var imodel = this.model, ifrm = this.frm, content-active-error-message = this.msg;
//         $(ifrm).on("ajax:error", function(event, xhr) {
//           $(imsg).removeClass('hide');
//           var errors = JSON.parse(xhr.responseText).errors;
//           $.each(errors, (function(k, v) {
//             $("#errors ul").append("<li>" + '*' + k + v + "</li>");
